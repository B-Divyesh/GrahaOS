// user/libtls/trust_anchors.c — AUTO-GENERATED by
// scripts/gen_trust_anchors.py.  DO NOT EDIT BY HAND.
// Re-run the generator after etc/tls/trust.pem changes.
//
// Phase 29 FU29.B.bearssl_wire — static BearSSL trust-anchor table
// baked from the Mozilla CA bundle.  Pure C: no kernel deps, no
// runtime PEM/X.509 parsing.  libtls_init() returns the count.
#include <stddef.h>
...
const br_x509_trust_anchor g_grahaos_TAs[] = {
	{
...
const size_t g_grahaos_TAs_num =
	sizeof g_grahaos_TAs / sizeof g_grahaos_TAs[0];
